...
from keras.layers import Input, Convolution2D, AveragePooling2D, Dense, Dropout, Concatenate, Flatten, Multiply, Maximum # type: ignore

from keras import regularizers

def createHRNetModel(height, width, depth, num_classes):
    kernel_size_1 = 7
    kernel_size_2 = 3
    pool_size = 2
    conv_depth_1 = 32
    ...
    scale_1 = Convolution2D(conv_depth_2, (kernel_size_2, kernel_size_2), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.01))(inp_merged)
    scale_2 = Convolution2D(conv_depth_2, (kernel_size_2 + 2, kernel_size_2 + 2), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.01))(inp_merged)
    scale_3 = Convolution2D(conv_depth_2, (kernel_size_2 + 4, kernel_size_2 + 4), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.01))(inp_merged)
